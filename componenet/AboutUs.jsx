...
//               AI-Powered
//               <br />
//               <span className="text-[40px]">Healthcare Solutions</span>
//             </h2>
...
//                   <svg 
//                     className="flex-shrink-0 h-6 w-6 text-teal-600 mr-4"
//                     fill="none" 
//                     stroke="currentColor" 
//                     viewBox="0 0 24 24"
//                   >
...
//             <a 
//               href="#"
//               className="inline-flex items-center text-teal-600 hover:text-teal-800 text-lg font-medium"
//             >
//               Learn More
//               <svg 
...
//            <p className="text-lg text-gray-600">Expert healthcare professionals combining AI with medical excellence</p>
//          </div>
...
//                  </div>
//                  {/* Icon Circle */}
//                  <div className="absolute top-4 right-4 bg-teal-400 p-3 rounded-full text-white">
//                    {doctor.icon}
//                  </div>
//                </div>
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-[#1d7261] mb-12">Why Choose Our AI Healthcare Solutions</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Real-time Analysis",
                description: "Instant processing of medical data for faster decision-making",
                icon: "⏱️"
              },
              {
                title: "Predictive Analytics",
                description: "Advanced algorithms predicting health risks before symptoms appear",
                icon: "📈"
              },
              {
              ...
              {
                title: "24/7 Support",
                description: "Round-the-clock AI monitoring and human support",
                icon: "⚕️"
              }
            ].map((feature, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="text-4xl mb-4">{feature.icon}</div>
                <h3 className="text-xl font-semibold text-[#1d7261] mb-2">{feature.title}</h3>
      ...
      <div className="bg-[#1d7261] py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { number: "95%", label: "Diagnostic Accuracy" },
              { number: "24/7", label: "AI Monitoring" },
              { number: "10M+", label: "Processed Cases" },
              { number: "50+", label: "Global Partners" },
            ].map((stat, index) => (
              <div key={index} className="text-white">
                <div className="text-5xl font-bold mb-2">{stat.number}</div>
                <div className="text-lg uppercase tracking-wide">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-[#1d7261] mb-12">Integrated Healthcare Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "AI Diagnostic Suite",
                description: "Comprehensive diagnostic support across all major medical specialties",
                icon: "🩺"
              },
              {
                title: "Smart Health Monitoring",
                description: "Wearable-integrated continuous health tracking with AI alerts",
                icon: "⌚"
              },
              {
                title: "Virtual Health Assistant",
                description: "24/7 AI-powered health guidance and triage",
                icon: "🤖"
              },
              {
                title: "Clinical Decision Support",
                description: "Evidence-based treatment recommendations for physicians",
                icon: "💡"
              },
              {
                title: "Medical Imaging AI",
                description: "Advanced analysis of X-rays, CT scans, and MRIs",
                icon: "📷"
              },
              {
              ...
              <div key={index} className="p-8 border border-gray-200 rounded-xl hover:border-[#1d7261] transition-colors">
