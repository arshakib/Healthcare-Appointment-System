        ...
        {doctorsData?.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {doctorsData?.map((doctor) => (
              <div key={doctor.id} className=" rounded-md shadow-sm  overflow-hidden hover:shadow-md transition-all duration-300 group">
                <div className="relative">
                  {/* Doctor Image */}
                  <div className="h-[350px] flex items-center justify-center overflow-hidden">
                    <div className="w-full h-full ">
                      <Image src={doctor?.image} width={56} height={56} alt="doctor image" className="w-full h-full object-cover" />
                    </div>
                  </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h2 className="text-xl font-bold text-gray-900 group-hover:text-[#033137] transition-colors duration-300">{doctor.name}</h2>
